  ...
  return (
    ...
    <section id='products' className='max-container max-sm:mt-12 '>
      <div className='flex flex-col justify-start gap-5'>
        ...
        <p className='max-w-lg:mt-2 font-montserrat text-slate-gray'>Exeprerience top-notch quality and style with our sought-after selections. Discover a world of comforrt , design , and value</p>
